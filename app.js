...
function renderThomasInterview(){
  ...
  form.addEventListener('submit',async e=>{
    ...
    try{
      ...
      clearTimeout(timeout);textarea.disabled=false;submit.disabled=false;submit.innerHTML=sendIcon;textarea.focus();
    }
  });
